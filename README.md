...
- `POST /items`: Adds a new item to the list. Items are created with `completed: false` by default.
- `PATCH /items/{item_id}/complete`: Marks a specific item as completed.
